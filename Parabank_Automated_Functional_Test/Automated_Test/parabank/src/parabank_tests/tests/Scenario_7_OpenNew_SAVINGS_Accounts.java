...
public class Scenario_7_OpenNew_SAVINGS_Accounts extends D_1_BaseTest {
    ...
    Scenario 7:
        Open New SAVINGS Account
            ...
            - Choose the "SAVINGS" account type and open a new account.
    ...
    */
    ...
    public void openNewSAVINGSAccount() {
        newAccountPage.openNewSAVINGSAccount();
        Assert.assertTrue(newAccountPage.checkSuccessfulNewAccountOpened_1());
    }

    @Test(priority = 4)
    public void checkNewSAVINGSAccountIsOpened() {
